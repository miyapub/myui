...
const btnStyle='button{border-style:solid;border-width:0;cursor:pointer;font-family:inherit;font-weight:700;line-height:normal;margin:0 0 1.25em;position:relative;text-decoration:none;text-align:center;display:inline-block;padding-top:.75em;padding-right:1.5em;padding-bottom:.8125em;padding-left:1.5em;font-size:1em;border-radius:4px;outline:0}button.green{background-color:#A5DE37;border-color:#A5DE37}button.blue{background-color:#2daebf;border-color:#238896;color:#fff}';
const MyUI= ({ children }) => {
  return (
    <div>
      <style>
